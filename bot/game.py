...
# Texts
TEXTS: Dict[str, str] = {
    HINT_ATTRIBUTES: 'Juhu, ein Spiel! Bitte wähle zunächst aus, welche Eigenschaften eines '
    ...
    MULTIPLE_CHOICE: 'Schließlich kannst Du noch aussuchen, ob Du Multiple-Choice- oder '
