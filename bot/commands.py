...
def show_data(update: Update, context: CallbackContext) -> None:
    ...
    text = (
        f'Aktuell habe ich folgendes über Dich gespeichert:\n\n{member.to_str()}\n\n'
...
def help_message(update: Update, context: CallbackContext) -> None:
    ...
    """
    text = (
        'Okay, lass mich versuchen, Dir zu helfen. Folgende Infos sind vielleicht '
...
def start_inline(update: Update, context: CallbackContext) -> None:
    ...
    update.message.reply_text(
        ...
        reply_markup=InlineKeyboardMarkup.from_button(
            InlineKeyboardButton(text='Klick mich! 🙂', switch_inline_query_current_chat='')
        ),
    )
